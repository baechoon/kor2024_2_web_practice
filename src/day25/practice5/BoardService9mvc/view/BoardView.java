package day25.practice5.BoardService9mvc.view;

import day25.practice5.BoardService9mvc.controller.BoardController;
...
public class BoardView {
    ...
    void boardPrint(){
        ...
        for (int index=0;index<result.size();index++){
            System.out.print("게시내용"+result.get(index).getContent()+result.get(index).getWriter());
        }
    }
