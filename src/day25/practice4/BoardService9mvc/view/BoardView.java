package day25.practice4.BoardService9mvc.view;

import day25.practice3.BoardService9mvc.model.BoardDao;
import day25.practice4.BoardService9mvc.controller.BoardController;
import day25.practice4.BoardService9mvc.model.BoardDto;
...
//게시물 출력함수
    void boardPrint(){
        ...
        for (int index=0;index< result.size();index++){
            ...
            System.out.println("게시물 작성자"+result.get(index).getWriter());
        }
    }
